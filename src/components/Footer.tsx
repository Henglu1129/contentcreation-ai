...
const Footer = () => {
  return (
    <footer className="bg-foreground py-4 px-4 md:px-[120px]">
      <div className="flex justify-between items-center">
        {/* Social Icons - Left */}
        <div className="flex items-center gap-4">
          {/* Discord */}
          <a href="https://discord.gg/KK3zXcMkhg" target="_blank" rel="noopener noreferrer" className="text-card/70 hover:text-card transition-colors">
